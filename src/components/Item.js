    ...
    <div className="col ">
        <div className="card bordes-neon bg-black pb-2">
            ...
            <div className="card-body">
                ...
                <li className="list-unstyled card-text fs-5 mb-2">Precio: {price} U$S / <img width="20" height="20" src={usdtlogo} alt='tether'/> / <img width="20" height="20" src={usdclogo} alt='USD Coin'/></li>
                <li className="list-unstyled card-text fs-5 mb-3">Categoria: {category}</li>
