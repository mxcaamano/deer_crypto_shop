...
const ItemDetail = ({item}) => {
    ...
    return(
        <>
    {item.pictureUrl ?
    <div className="container col-xxl-8 px-3 py-3 my-3 bordes-neon bg-black">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-3">
            ...
            <div className="col-lg-6">
                ...
                <h2 className="display-7 fw-bold lh-1 mb-3">Precio: {item.price} U$S / <img width="35" height="35" src={usdtlogo}/> / <img width="35" height="35" src={usdclogo}/></h2>
    ...
    :
    <img className="d-block mx-lg-auto img-fluid mb-3" src={loading} width="200" height="200"/>
    }
    </>
    )
}
